    ...
    return (
        <header
            ...
            <nav className="flex items-center justify-center flex-wrap">
                <motion.a href="https://twitter.com/ArpaKanij" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 mr-3"
                >
                ...
                <motion.a href="https://github.com/KanijFatemaArpa" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 mx-3"
                >
                ...
                <motion.a href="https://www.linkedin.com/in/kanij-fatema-arpa-a813582a7/" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 mx-3"
                >
                ...
                <motion.a href="https://www.pinterest.com/fatemaarpa/" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                ...
                <motion.a href="https://dribbble.com/Arpa32" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 ml-3"
                >
            ...
            left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg
