    ...
    return (
        ...
        Education
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                <ul className="w-1/2 flex flex-col items-start justify-between ml-4 xs:ml-2">
                    <Details 
                        type=" Bachelor Of Science In Computer Science and Engineering" 
                        time="2018-2023 "
                        place="East West University, Aftabnagar, Dhaka"
                        info="CGPA 3.36"
                    ...
                    <Details 
                        ...
                        time="2015-2017 "
                        place="Ideal College, Dhanmondi, Dhaka "
                        info="GPA 4.7"
                    
                    />

                    <Details 
                        type=" Secondary Education In Science" 
                        time="2013-2015 "
                        place="Makhati G.c High School, Makhati, Munshigang"
                        info="GPA 5"
